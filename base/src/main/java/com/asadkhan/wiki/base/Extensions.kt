...
import com.asadkhan.wiki.base.AbstractApplication.Companion.component
...
fun preference(): SharedPreferences = component().sharedPreferences()
...
fun contex(): Context = AbstractApplication.component().application
